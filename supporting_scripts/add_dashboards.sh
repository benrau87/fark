...
dash=$dir/forensic-grr-elk/dashboards/dashboard/
search=$dir/forensic-grr-elk/dashboards/search/
vis=$dir/forensic-grr-elk/dashboards/visualization/
index=$dir/forensic-grr-elk/dashboards/index-pattern/
